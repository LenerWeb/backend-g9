...
# Manager > administrador es el qeu se encargara de la creacion de usuario por comando
...
class UsuarioManager(BaseUserManager):
    ...
    def create_superuser(self, correo, nombre, apellido, tipoUsuario, password):
        # Metodo qeu se mandara a llamar cuando se ejecute el comando 'createsuperuser'
