...
# sirve para leer el archivo .env y cargar las variables definidas en este archivo como variables de entornio
...
#almacena todas las variables de configuracion de la apliucacion de flask
...
# un decorador es la forma en la cual nosotros podemos modificar el comportamiento de un metodo de una clase sin la necesidad de modificarlo directamente, es como utilizar la herencia para poder modificar su comportamiento, en este casdo, dependiendo de su ruta y su metodo
