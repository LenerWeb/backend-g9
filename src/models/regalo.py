...
class RegaloModel(conexion.Model):
    ...
    url = Column(type_=types.String(length=100), nullable=True)
    ...
    # backref > es un atributo virtual qeu se creara en el otro modelo (en usuariomodel) y con este atributo se podra acceder a todo los regalos
