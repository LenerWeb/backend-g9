...
class PruebaApiView(ListCreateAPIView):
    # vistas genericas me piden dos atributos, sirven para trabajar con modelos de la base de datos, no se suele trabajar con informacion aisalada
    # serializer_class > DTO que convertia la informacion entrante a tipos de datos conocidos por Python y convertia la informacion salientea tipos de datos conocidos por los JSON
    ...
    def post(self, request:Request):
        ...
        if not dataValida:
            return Response(data={
                ...
                # error > mostrara los errores el porque la data es invalida
                'content': serializador.errors
            })
        else:
            # validated_data > mostrara la data ya validada, osea ya pasada por el filtro del serializado
