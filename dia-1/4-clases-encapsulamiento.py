...
class Producto:
    ...
    def __sacar_igv(self, precio):
        # Este metodo pasa a ser privado desde qeu lo ponemos '__' al inicio del nombre
        print(precio*0.18)
...
# No se puede tener acceso al metodo __sacar_igv dede que es un metodo privado
