class Documento:
    def __init__(self, tipo, num_paginas, editable, contenido):
        #sera el metodo que se llame cuando creemos una instancia de la clase
    ...
    def editar_documento(self, nuevo_contenido):
        #sie el documento no es editable entonces indicar qeu no se puede editar el documento, caso contrario modificar la informacion del atributo dontenido
